...
WHERE
    ...
    ( -- только за 2011 год
        (Н_УЧЕНИКИ.НАЧАЛО >= '2011-01-01 00:00:00' AND Н_УЧЕНИКИ.НАЧАЛО < '2012-01-01 00:00:00') OR
        (Н_УЧЕНИКИ.КОНЕЦ >= '2011-01-01 00:00:00' AND Н_УЧЕНИКИ.КОНЕЦ < '2012-01-01 00:00:00')
    ) AND
